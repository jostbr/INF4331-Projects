...
def mandelbrot_python(x_min, x_max, y_min, y_max, width, height, max_escape_iter = 1000):
    ...
    for i in range(0, height):
        for j in range(0, width):
            ...
            while ((abs(z_complex) < 2.0) and (current_iter < max_escape_iter)):  # While sequence doesn't exceed 2 in abs-val and max esc-time not reached
...
if (__name__ == "__main__"):
    ...
    width = 200; height = 200; grid_size = 200; max_escape_iter = 1000
